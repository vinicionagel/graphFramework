...
import graph.Graph;
/**
 * Annotations @colorVertex(Color.RED), @algoritmo(ENUM.DJASTRA,VertexInicial = "1",solucaoCor.RED)
 * @author root
 *
 */
public class ClassesTestHerancaSimples extends Graph{
	
	public ClassesTestHerancaSimples() {
		super(false);
	}
	
	public static void main(String[] args) {
		new ClassesTestHerancaSimples().implementaGrafo();
	}
